        ...
        <div class="modal-content">
            <form id="cancelRecurringForm" method="POST">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Cancel Recurring Booking (Admin)</h5>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" name="cancellation_reason" id="cancelRecurringReason" rows="3" required
                            maxlength="500" placeholder="Reason for administrative cancellation..."></textarea>
                    </div>
                </div>
...
<script>
    function confirmCancelRecurring(bookingId, reference, date, bookingUrl) {
        ...
        const url = bookingUrl || `/admin/bookings/${bookingId}`;
        form.action = url;
