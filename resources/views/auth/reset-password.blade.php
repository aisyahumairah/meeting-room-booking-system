...
@section('meta_description', 'Reset your password for Meeting Room Booking System')
            ...
            <div class="authentication-inner py-6">
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <p class="mb-6">Enter your new password below. Password must be at least 8 characters and contain
                        ...
                        <form id="formAuthentication" action="{{ route('password.update') }}" method="POST">
                            ...
                            <button class="btn btn-primary d-grid w-100 mb-6" type="submit">Reset Password</button>
                        </form>
