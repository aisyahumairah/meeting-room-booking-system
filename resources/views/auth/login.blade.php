...
@section('title', 'Login')
@section('meta_description', 'Login to Meeting Room Booking System')
            ...
            <div class="authentication-inner">
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <h4 class="mb-1">Welcome to MRBS! 👋</h4>
                        <p class="mb-6">Please sign-in to your account and start booking rooms.</p>
